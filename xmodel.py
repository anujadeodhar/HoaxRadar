...
passiveaggressive_model=pickle.load(open(r"C:\Users\Anuja\Downloads\hoax-radar-main\model.pickle","rb"))
tfidf_vectorizer=pickle.load(open(r"C:\Users\Anuja\Downloads\hoax-radar-main\vectorizer.pickle","rb"))
